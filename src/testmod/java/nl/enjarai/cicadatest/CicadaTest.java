...
public class CicadaTest implements ModInitializer, CicadaEntrypoint {
    ...
    public void registerConversations(ConversationManager conversationManager) {
        ...
        conversationManager.registerSource(
                YamlSource.fromUrl("https://raw.githubusercontent.com/enjarai/cicada-lib/master/src/testmod/resources/cicada/cicada/conversations.yml")
                        .or(YamlSource.fromResource("cicada/cicada-test/conversations.yml"))
        );
    }
